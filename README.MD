...
Crie um elemento link dentro do head do seu arquivo e adicione os atributos _rel="stylesheet"_ e _href="style.css"_, o rel denota o tipo de arquivo que estamos incluindo na página e o href é o caminho para o arquivo. E na mesma pasta do arquivo HTML crie um arquivo chamado **style.css.**
...
- [x] As margens (margin) são espaçamentos entre elementos;
- [x] As bordas (border) ;
- [x] O padding é um espaçamento entre as bordas e o conteúdo, a diferença para as margens é que declarações de imagem de fundo funcionam nele;
- [x] O conteúdo (content) é o que o seu bloco representa, um texto, uma imagem, um vídeo;
